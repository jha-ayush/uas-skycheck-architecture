...
| | |
|---|---|
| **You may** | Read it, link to it, and share it, with attribution |
| **You may not** | Sell it, use it commercially, or publish adapted or derivative versions |
...
This license covers the **documentation in this repository and nothing else**.

It grants no rights whatsoever in the UAS SkyCheck software, its source code, or
its datasets, all of which are proprietary and separately licensed (all rights
reserved, SudoKodes LLC). Describing a system is not licensing it.

## Brand assets

UAS SkyCheck, the UAS SkyCheck logo, and SudoKodes are trademarks of
...
`assets/uas_skycheck_logo.png` and `assets/uas_skycheck_social.png`) are **not**
licensed under CC BY-NC-ND 4.0. They are
